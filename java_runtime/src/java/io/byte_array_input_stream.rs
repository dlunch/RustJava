...
impl ByteArrayInputStream {
    ...
    async fn init(jvm: &mut Jvm, mut this: JvmClassInstanceHandle<Self>, data: JvmClassInstanceHandle<Array<i8>>) -> JavaResult<()> {
    ...
    async fn read_byte(jvm: &mut Jvm, mut this: JvmClassInstanceHandle<Self>) -> JavaResult<i8> {
    ...
    async fn close(_: &mut Jvm, this: JvmClassInstanceHandle<ByteArrayInputStream>) -> JavaResult<()> {
