...
impl ByteArrayInputStream {
    ...
    async fn init(jvm: &mut Jvm, _: &JavaContext, mut this: JvmClassInstanceHandle<Self>, data: JvmClassInstanceHandle<Array<i8>>) -> JavaResult<()> {
    ...
    async fn available(jvm: &mut Jvm, _: &JavaContext, this: JvmClassInstanceHandle<Self>) -> JavaResult<i32> {
    ...
    async fn read_byte(jvm: &mut Jvm, _: &JavaContext, mut this: JvmClassInstanceHandle<Self>) -> JavaResult<i8> {
    ...
    async fn close(_: &mut Jvm, _: &JavaContext, this: JvmClassInstanceHandle<ByteArrayInputStream>) -> JavaResult<()> {
