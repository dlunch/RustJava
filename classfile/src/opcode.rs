...
impl Opcode {
    /// Parses one instruction, preserving byte-relative branch offsets.
    /// Code attribute parsing resolves these offsets to instruction indices.
    ...
    fn parse_opcode<'a>(opcode: u8, offset: usize, data: &'a [u8], constant_pool: &BTreeMap<u16, ConstantPoolItem>) -> IResult<&'a [u8], Self> {
        match opcode {
            ...
            .parse(data),
            0xa7 => map(be_i16, |x| Opcode::Goto(i32::from(x))).parse(data),
            ...
            0xa5 => map(be_i16, |x| Opcode::IfAcmpeq(i32::from(x))).parse(data),
            0xa6 => map(be_i16, |x| Opcode::IfAcmpne(i32::from(x))).parse(data),
            0x9f => map(be_i16, |x| Opcode::IfIcmpeq(i32::from(x))).parse(data),
            0xa0 => map(be_i16, |x| Opcode::IfIcmpne(i32::from(x))).parse(data),
            0xa1 => map(be_i16, |x| Opcode::IfIcmplt(i32::from(x))).parse(data),
            0xa2 => map(be_i16, |x| Opcode::IfIcmpge(i32::from(x))).parse(data),
            0xa3 => map(be_i16, |x| Opcode::IfIcmpgt(i32::from(x))).parse(data),
            0xa4 => map(be_i16, |x| Opcode::IfIcmple(i32::from(x))).parse(data),
            0x99 => map(be_i16, |x| Opcode::Ifeq(i32::from(x))).parse(data),
            0x9a => map(be_i16, |x| Opcode::Ifne(i32::from(x))).parse(data),
            0x9b => map(be_i16, |x| Opcode::Iflt(i32::from(x))).parse(data),
            0x9c => map(be_i16, |x| Opcode::Ifge(i32::from(x))).parse(data),
            0x9d => map(be_i16, |x| Opcode::Ifgt(i32::from(x))).parse(data),
            0x9e => map(be_i16, |x| Opcode::Ifle(i32::from(x))).parse(data),
            0xc7 => map(be_i16, |x| Opcode::Ifnonnull(i32::from(x))).parse(data),
            0xc6 => map(be_i16, |x| Opcode::Ifnull(i32::from(x))).parse(data),
            ...
            0xa8 => map(be_i16, |x| Opcode::Jsr(i32::from(x))).parse(data),
